                ...
                <Container>
                    <Grid style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }} container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                                ...
                                {!isLoading &&
                                    <form style={{ width: '100%' }} onSubmit={handleRegister}>
                                        ...
                                        <Box>
                                            <Button
                                                type="submit"
                                                style={{ width: '100%', padding: '10px', backgroundColor: '#6C63FF', marginTop: '10px' }} variant="contained">Register</Button>
                                        </Box>
                        ...
                        <Grid item xs={12} md={6} lg={6}>
                            <img className='img-fluid' src="https://i.ibb.co/wyVTMRF/login.png" alt="" />
                        </Grid>
                    </Grid>
                </Container>
